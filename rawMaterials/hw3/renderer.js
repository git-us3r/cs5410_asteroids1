...
MYGAME.graphicsInit = function() {
    ...
    var img3 = new Image();
    img3.src = 'textures/Background.png';
    MYGAME.images.pic_bg = img3;

    var img_money = new Image();
    img_money.src = 'textures/money.png';
    MYGAME.images.pic_money = img_money;
    ...
    ///
     MYGAME.context.clear = function () {
         ...
         //MYGAME.context.drawImage(MYGAME.images.pic_bg, 0, 0, MYGAME.canvas.width, MYGAME.canvas.height);
